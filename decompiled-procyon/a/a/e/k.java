...
final class k
{
    ...
    static void a(final f f, final d d) {
        int i = 0;
        long n = 0L;
        int j = 0;
        while (i < f.g()) {
    ...
    private void b() {
        for (int i = 0; i < k.b.length; ++i) {
            ...
            int j = 0;
            for (int n3 = 8 - b; j < (j = (n << n3 & 0xFF)) + (1 << n3); ++j) {
                d.a[j] = a;
            }
        }
    }
    
    final byte[] a(final byte[] array) {
