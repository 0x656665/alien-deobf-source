...
final class c extends b implements h.b
{
    final h a;
    final /* synthetic */ g c;
    ...
    public final void a(final int n, final b b) {
        if (a.a.e.g.d(n)) {
            final g c = this.c;
            c.i.execute(new b(new Object[] { c.e, n }) {
    ...
    public final void a(final boolean b, final int n, final int n2) {
        if (!b) {
            final g c = this.c;
            a.a.e.g.a.execute(new b(new Object[] { c.e, n, n2 }) {
    ...
    public final void a(final boolean b, final int f, final List<a.a.e.c> e) {
        ...
        if (d) {
            final g c = this.c;
            c.i.execute(new b(new Object[] { c.e, f }) {
                final /* synthetic */ int a;
        ...
        synchronized (c2) {
            ...
            if (a2 == null) {
                ...
                this.c.f = f;
                this.c.d.put(f, i);
                a.a.e.g.a.execute(new b("OkHttp %s stream %d", new Object[] { this.c.e, f }) {
                    final /* synthetic */ i a;
                    final /* synthetic */ c c;
